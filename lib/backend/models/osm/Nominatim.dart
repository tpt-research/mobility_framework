...
class Nominatim {
  ...
  factory Nominatim.fromRawJson(String str) =>
      Nominatim.fromJson(json.decode(str));
  ...
  factory Nominatim.fromJson(Map<String, dynamic> json) => new Nominatim(
        ...
        boundingbox: json["boundingbox"] == null
            ? null
            : new List<String>.from(json["boundingbox"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "boundingbox": boundingbox == null
            ? null
            : new List<dynamic>.from(boundingbox.map((x) => x)),
      };
}
...
class Address {
  ...
  factory Address.fromJson(Map<String, dynamic> json) => new Address(
        ...
        cityDistrict:
            json["city_district"] == null ? null : json["city_district"],
        city: json["city"] == null ? null : json["city"],
        county: json["county"] == null ? null : json["county"],
        stateDistrict:
            json["state_district"] == null ? null : json["state_district"],
