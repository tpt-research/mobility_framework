...
import 'package:mobility_framework/backend/models/main/Location.dart';
...
class LocationModel {
  ...
  factory LocationModel.fromJson(Map<String, dynamic> json) =>
      new LocationModel(
        ...
        suggestedLocations: json["suggestedLocations"] == null
            ? null
            : new List<SuggestedLocation>.from(json["suggestedLocations"]
  ...
  Map<String, dynamic> toJson() => {
        ...
        "suggestedLocations": suggestedLocations == null
            ? null
            : new List<dynamic>.from(suggestedLocations.map((x) => x.toJson())),
        "locations": locations == null
            ? null
            : new List<dynamic>.from(locations.map((x) => x.toJson())),
      };
}
