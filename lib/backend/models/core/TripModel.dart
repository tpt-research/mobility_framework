...
import 'package:mobility_framework/backend/models/main/Context.dart';
import 'package:mobility_framework/backend/models/main/From.dart';
...
class TripModel {
  ...
  factory TripModel.fromJson(Map<String, dynamic> json) => new TripModel(
        ...
        trips: json["trips"] == null
            ? null
            : new List<Trip>.from(json["trips"].map((x) => Trip.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "trips": trips == null
            ? null
            : new List<dynamic>.from(trips.map((x) => x.toJson())),
      };
}
