...
class TermsConditions {
  ...
  factory TermsConditions.fromRawJson(String str) =>
  ...
  factory TermsConditions.fromJson(Map<String, dynamic> json) =>
      TermsConditions(
        acceptedTermsConditions: json["AcceptedTermsConditions"] == null
            ? null
            : json["AcceptedTermsConditions"],
  ...
  Map<String, dynamic> toJson() => {
        "AcceptedTermsConditions":
            acceptedTermsConditions == null ? null : acceptedTermsConditions,
