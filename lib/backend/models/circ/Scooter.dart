...
class Scooter {
  ...
  factory Scooter.fromJson(Map<String, dynamic> json) => Scooter(
        ...
        idScooterState:
            json["idScooterState"] == null ? null : json["idScooterState"],
        latLng: json["LatLng"] == null ? null : LatLng.fromJson(json["LatLng"]),
        distance: json["Distance"] == null ? null : json["Distance"].toDouble(),
        powerPercent:
            json["PowerPercent"] == null ? null : json["PowerPercent"],
        remainderRange:
            json["RemainderRange"] == null ? null : json["RemainderRange"],
        powerPercentInt:
            json["PowerPercentInt"] == null ? null : json["PowerPercentInt"],
        scooterModel:
            json["ScooterModel"] == null ? null : json["ScooterModel"],
        ...
        txtRentalPrice:
            json["txtRentalPrice"] == null ? null : json["txtRentalPrice"],
        bookingDurationMinutes: json["BookingDurationMinutes"] == null
            ? null
            : json["BookingDurationMinutes"],
        ...
        googleMapsMode:
            json["GoogleMapsMode"] == null ? null : json["GoogleMapsMode"],
        googleMapsEstimatedTimeRatio:
            json["GoogleMapsEstimatedTimeRatio"] == null
                ? null
                : json["GoogleMapsEstimatedTimeRatio"],
        costEstimationEnabled: json["CostEstimationEnabled"] == null
            ? null
            : json["CostEstimationEnabled"],
        cityName: json["CityName"] == null ? null : json["CityName"],
        scooterStatus:
            json["ScooterStatus"] == null ? null : json["ScooterStatus"],
        gsmCoverage: json["GSMCoverage"] == null ? null : json["GSMCoverage"],
        satelliteNumber:
            json["SatelliteNumber"] == null ? null : json["SatelliteNumber"],
        gpsStatusTxt:
            json["GPSStatus_txt"] == null ? null : json["GPSStatus_txt"],
        gpsStatusSort:
            json["GPSStatus_sort"] == null ? null : json["GPSStatus_sort"],
        gpsStatusInt:
            json["GPSStatus_int"] == null ? null : json["GPSStatus_int"],
        iotStatusTxt:
            json["IOTStatus_txt"] == null ? null : json["IOTStatus_txt"],
        iotStatusSort:
            json["IOTStatus_sort"] == null ? null : json["IOTStatus_sort"],
        iotStatusInt:
            json["IOTStatus_int"] == null ? null : json["IOTStatus_int"],
        ...
        sortLocation: json["sort_Location"] == null
            ? null
            : json["sort_Location"].toDouble(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "BookingDurationMinutes":
            bookingDurationMinutes == null ? null : bookingDurationMinutes,
        ...
        "GoogleMapsEstimatedTimeRatio": googleMapsEstimatedTimeRatio == null
            ? null
            : googleMapsEstimatedTimeRatio,
        "CostEstimationEnabled":
            costEstimationEnabled == null ? null : costEstimationEnabled,
