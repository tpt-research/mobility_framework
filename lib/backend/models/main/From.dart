...
class From {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "products": products == null
            ? null
            : new List<dynamic>.from(products.map((x) => x)),
