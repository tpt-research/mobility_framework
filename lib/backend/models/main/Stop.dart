...
class Stop {
  ...
  factory Stop.fromJson(Map<String, dynamic> json) => new Stop(
        ...
        plannedArrivalPosition: json["plannedArrivalPosition"] == null
            ? null
            : Position.fromJson(json["plannedArrivalPosition"]),
        predictedArrivalPosition: json["predictedArrivalPosition"],
        arrivalCancelled:
            json["arrivalCancelled"] == null ? null : json["arrivalCancelled"],
        ...
        plannedDeparturePosition: json["plannedDeparturePosition"] == null
            ? null
            : Position.fromJson(json["plannedDeparturePosition"]),
        predictedDeparturePosition: json["predictedDeparturePosition"],
        departureCancelled: json["departureCancelled"] == null
            ? null
            : json["departureCancelled"],
        departureTimePredicted: json["departureTimePredicted"] == null
            ? null
            : json["departureTimePredicted"],
        arrivalPosition: json["arrivalPosition"] == null
            ? null
            : Position.fromJson(json["arrivalPosition"]),
        departureDelay: json["departureDelay"],
        departurePositionPredicted: json["departurePositionPredicted"] == null
            ? null
            : json["departurePositionPredicted"],
        departurePosition: json["departurePosition"] == null
            ? null
            : Position.fromJson(json["departurePosition"]),
        arrivalTimePredicted: json["arrivalTimePredicted"] == null
            ? null
            : json["arrivalTimePredicted"],
        departureTime:
            json["departureTime"] == null ? null : json["departureTime"],
        arrivalTime: json["arrivalTime"] == null ? null : json["arrivalTime"],
        arrivalPositionPredicted: json["arrivalPositionPredicted"] == null
            ? null
            : json["arrivalPositionPredicted"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "plannedArrivalTime":
            plannedArrivalTime == null ? null : plannedArrivalTime,
        "predictedArrivalTime": predictedArrivalTime,
        "plannedArrivalPosition": plannedArrivalPosition == null
            ? null
            : plannedArrivalPosition.toJson(),
        "predictedArrivalPosition": predictedArrivalPosition,
        "arrivalCancelled": arrivalCancelled == null ? null : arrivalCancelled,
        "plannedDepartureTime":
            plannedDepartureTime == null ? null : plannedDepartureTime,
        "predictedDepartureTime": predictedDepartureTime,
        "plannedDeparturePosition": plannedDeparturePosition == null
            ? null
            : plannedDeparturePosition.toJson(),
        "predictedDeparturePosition": predictedDeparturePosition,
        "departureCancelled":
            departureCancelled == null ? null : departureCancelled,
        "departureTimePredicted":
            departureTimePredicted == null ? null : departureTimePredicted,
        "arrivalPosition":
            arrivalPosition == null ? null : arrivalPosition.toJson(),
        "departureDelay": departureDelay,
        "departurePositionPredicted": departurePositionPredicted == null
            ? null
            : departurePositionPredicted,
        "departurePosition":
            departurePosition == null ? null : departurePosition.toJson(),
        "arrivalTimePredicted":
            arrivalTimePredicted == null ? null : arrivalTimePredicted,
        "departureTime": departureTime == null ? null : departureTime,
        "arrivalTime": arrivalTime == null ? null : arrivalTime,
        "arrivalPositionPredicted":
            arrivalPositionPredicted == null ? null : arrivalPositionPredicted,
