...
class Trip {
  ...
  factory Trip.fromJson(Map<String, dynamic> json) => new Trip(
        ...
        lastPublicLeg: json["lastPublicLeg"] == null
            ? null
            : LastPublicLeg.fromJson(json["lastPublicLeg"]),
        travelable: json["travelable"] == null ? null : json["travelable"],
        firstPublicLeg: json["firstPublicLeg"] == null
            ? null
            : FirstPublicLeg.fromJson(json["firstPublicLeg"]),
        firstPublicLegDepartureTime: json["firstPublicLegDepartureTime"] == null
            ? null
            : json["firstPublicLegDepartureTime"],
        lastArrivalTime:
            json["lastArrivalTime"] == null ? null : json["lastArrivalTime"],
        lastPublicLegArrivalTime: json["lastPublicLegArrivalTime"] == null
            ? null
            : json["lastPublicLegArrivalTime"],
        publicDuration:
            json["publicDuration"] == null ? null : json["publicDuration"],
        firstDepartureTime: json["firstDepartureTime"] == null
            ? null
            : json["firstDepartureTime"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "firstPublicLeg":
            firstPublicLeg == null ? null : firstPublicLeg.toJson(),
        "firstPublicLegDepartureTime": firstPublicLegDepartureTime == null
            ? null
            : firstPublicLegDepartureTime,
        "lastArrivalTime": lastArrivalTime == null ? null : lastArrivalTime,
        "lastPublicLegArrivalTime":
            lastPublicLegArrivalTime == null ? null : lastPublicLegArrivalTime,
        "publicDuration": publicDuration == null ? null : publicDuration,
        "firstDepartureTime":
            firstDepartureTime == null ? null : firstDepartureTime,
