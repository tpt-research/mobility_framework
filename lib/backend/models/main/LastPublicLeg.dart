...
class LastPublicLeg {
  ...
  factory LastPublicLeg.fromRawJson(String str) =>
      LastPublicLeg.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LastPublicLeg.fromJson(Map<String, dynamic> json) =>
      new LastPublicLeg(
        departure:
            json["departure"] == null ? null : From.fromJson(json["departure"]),
        arrival:
            json["arrival"] == null ? null : From.fromJson(json["arrival"]),
        line: json["line"] == null ? null : Line.fromJson(json["line"]),
        destination: json["destination"] == null
            ? null
            : From.fromJson(json["destination"]),
        departureStop: json["departureStop"] == null
            ? null
            : Stop.fromJson(json["departureStop"]),
        arrivalStop: json["arrivalStop"] == null
            ? null
            : Stop.fromJson(json["arrivalStop"]),
        intermediateStops: json["intermediateStops"] == null
            ? null
            : new List<Stop>.from(
                json["intermediateStops"].map((x) => Stop.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "intermediateStops": intermediateStops == null
            ? null
            : new List<dynamic>.from(intermediateStops.map((x) => x.toJson())),
        "message": message,
