...
class StationDeparture {
  ...
  factory StationDeparture.fromRawJson(String str) =>
      StationDeparture.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory StationDeparture.fromJson(Map<String, dynamic> json) =>
      new StationDeparture(
        location: json["location"] == null
            ? null
            : Location.fromJson(json["location"]),
        departures: json["departures"] == null
            ? null
            : new List<Departure>.from(
                json["departures"].map((x) => Departure.fromJson(x))),
        lines: json["lines"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "departures": departures == null
            ? null
            : new List<dynamic>.from(departures.map((x) => x.toJson())),
        "lines": lines,
      };
