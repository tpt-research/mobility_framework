...
class Trip {
  ...
  factory Trip.fromJson(Map<String, dynamic> json) => new Trip(
        tripDate:
            json["tripDate"] == null ? null : DateTime.parse(json["tripDate"]),
        trainType: json["trainType"] == null ? null : json["trainType"],
        vzn: json["vzn"] == null ? null : json["vzn"],
        actualPosition:
            json["actualPosition"] == null ? null : json["actualPosition"],
        distanceFromLastStop: json["distanceFromLastStop"] == null
            ? null
            : json["distanceFromLastStop"],
        totalDistance:
            json["totalDistance"] == null ? null : json["totalDistance"],
        stopInfo: json["stopInfo"] == null
            ? null
            : StopInfo.fromJson(json["stopInfo"]),
        stops: json["stops"] == null
            ? null
            : new List<Stop>.from(json["stops"].map((x) => Stop.fromJson(x))),
      );
