...
class Info {
  ...
  factory Info.fromJson(Map<String, dynamic> json) => new Info(
        ...
        positionStatus:
            json["positionStatus"] == null ? null : json["positionStatus"],
        distance: json["distance"] == null ? null : json["distance"],
        distanceFromStart: json["distanceFromStart"] == null
            ? null
            : json["distanceFromStart"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "distanceFromStart":
            distanceFromStart == null ? null : distanceFromStart,
      };
}
