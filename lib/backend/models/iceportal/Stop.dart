...
class Stop {
  ...
  factory Stop.fromJson(Map<String, dynamic> json) => new Stop(
        ...
        delayReasons: json["delayReasons"] == null
            ? null
            : new List<DelayReason>.from(
                json["delayReasons"].map((x) => DelayReason.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "delayReasons": delayReasons == null
            ? null
            : new List<dynamic>.from(delayReasons.map((x) => x.toJson())),
      };
}
