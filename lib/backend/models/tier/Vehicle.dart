...
class Vehicle {
  ...
  factory Vehicle.fromJson(Map<String, dynamic> json) => Vehicle(
        ...
        lastStateChange: json["lastStateChange"] == null
            ? null
            : DateTime.parse(json["lastStateChange"]),
        batteryLevel:
            json["batteryLevel"] == null ? null : json["batteryLevel"],
        lat: json["lat"] == null ? null : json["lat"].toDouble(),
        lng: json["lng"] == null ? null : json["lng"].toDouble(),
        maxSpeed: json["maxSpeed"] == null ? null : json["maxSpeed"],
        zoneId: json["zoneId"] == null ? null : json["zoneId"],
        licencePlate:
            json["licencePlate"] == null ? null : json["licencePlate"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "lastStateChange":
            lastStateChange == null ? null : lastStateChange.toIso8601String(),
