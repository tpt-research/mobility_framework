import 'package:mobility_framework/backend/constants/FlixConstants.dart';
import 'package:mobility_framework/backend/http/SuperchargedHttp.dart';
import 'package:mobility_framework/backend/models/core/DB2FlixModel.dart';
import 'package:mobility_framework/backend/models/core/FlixbusJourneyModel.dart';
import 'package:mobility_framework/backend/models/core/FlixbusQueryModel.dart';

class FlixbusService {
  static Future<FlixbusJourneyModel> getJourney(String from, String fromType,
      String to, String toType, String when) async {
